...
RIPEMD160.MDbuf = [1732584193, -271733879, -1732584194, 271733878, -1009589776];
RIPEMD160.working = new Int32Array(16);
RIPEMD160.working_ptr = 0;
RIPEMD160.msglen = 0;
...
RIPEMD160.reset = function() {
    this.MDbuf = [1732584193, -271733879, -1732584194, 271733878, -1009589776];
...
//
//return : void
RIPEMD160.MDfinish = function(array, lswlen, mswlen) {
    const X = array;
...
//
//return : void
RIPEMD160.update = function (input) {
...
//
//return : Int8Array
RIPEMD160.digest = function(input) {    
