import { TransactionSign } from '../src/core/transaction/TransactionSign';
...
export const tranSign = async (
  ...
  try {
    ...
    const tx = new TransactionSign(privateAccount, feePow, timestamp, reference, seqNo, port, genesis_sign);
