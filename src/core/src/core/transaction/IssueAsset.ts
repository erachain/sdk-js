...
export class IssueAsset extends Issue_ItemRecord {
    ...
    public constructor(creator: PrivateKeyAccount, asset: AssetCls, feePow: number, timestamp: number, reference: number, port: number) {
        super(new Int8Array([IssueAsset.TYPE_ID, 0, 0, 0]), IssueAsset.NAME_ID, creator, asset, feePow, timestamp, reference, port);
    }
