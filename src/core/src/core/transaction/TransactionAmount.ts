...
export class TransactionAmount extends Transaction {
    ...
    constructor(typeBytes: Int8Array, name: string, creator: PrivateKeyAccount, feePow: number, recipient: Account, amount: BigDecimal | null, key: number, timestamp: number, reference: number, port: number) {
