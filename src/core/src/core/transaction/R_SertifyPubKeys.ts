...
export class R_SertifyPubKeys extends Transaction {
    ...
    constructor(creator: PrivateKeyAccount, feePow: number, key: number, sertifiedPublicKey: PublicKeyAccount, add_day: number, timestamp: number, reference: number, port: number) {
        const verions = 0;
