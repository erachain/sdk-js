...
export class R_Send extends TransactionAmount {
    ...
    constructor(creator: PrivateKeyAccount, feePow: number, recipient: Account, key: number, amount: BigDecimal | null, head: string | null, data: Int8Array | null, isText: Int8Array, encrypted: Int8Array, timestamp: number, reference: number, port: number) {
